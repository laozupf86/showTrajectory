...
public class TestWindowQuery {
	public static void main(String args[]) throws IOException {
		...
		try {
			...
			FrameTableWindowQuery iFrame = new FrameTableWindowQuery(minTime, 60000, 1);
			iFrame.importBulkofData(sp);
			
			IPFrameTableWindowQuery IP = new IPFrameTableWindowQuery(minTime, 60000, 1, 5);
			...
			for (int k = 0; k < iter; k++) {
				...
				for (int j = 0; j < 6; j++) {
					...
					System.gc();
					startTime = System.currentTimeMillis();
					iFrame.SpatialWindowQuery(randLongi, randLati, distance);
					endTime = System.currentTimeMillis();
					totalTime = endTime - startTime;
					...
					System.gc();
					startTime = System.currentTimeMillis();
					IP.SpatialWindowQuery(randLongi, randLati,distance);
					endTime = System.currentTimeMillis();
					totalTime = endTime - startTime;
				...
				for (int i = 1; i < 7; i++) {
					...
					for (int j = 0; j < 6; j++) {
						...
						System.gc();
						startTime = System.currentTimeMillis();
						iFrame.SpatialTemporalWindowQuery(randTime, timeRange,randLongi, randLati, distance);
						endTime = System.currentTimeMillis();
						totalTime = endTime - startTime;
						...
						System.gc();
						startTime = System.currentTimeMillis();
						IP.SpatialTemporalWindowQuery(randTime, timeRange,randLongi, randLati, distance);
						endTime = System.currentTimeMillis();
						totalTime = endTime - startTime;
